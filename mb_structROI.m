...
%ex: [conArray, p, stats] = mb_structROI('BaleenHP','ya_mri_baleenhp','Unrelated Target vs. Related Target - All Sessions', 'MNI_Temporal_Pole_Sup_L_roi.mat')
...
dataPath = '/autofs/cluster/kuperberg/SemPrMM/MRI/';
subjList = (dlmread(strcat(dataPath,'scripts/input/',listPrefix,'_mb.txt')))';
...
for s = subjList
    s
    root_dir = strcat('/autofs/cluster/kuperberg/SemPrMM/MRI/functionals/ya',int2str(s),'/',exp,'/stats_outliers/8mm/');
