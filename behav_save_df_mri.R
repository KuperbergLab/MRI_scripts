behav_save_df_mri <-function(subjType,exp){
	
filePath <- "/cluster/kuperberg/SemPrMM/MRI/results/behavioral_accuracy/R/"
fileName <- paste(filePath,'MRI_',subjType,'_',exp,"_accuracy.log",sep="")
...
outFile <-paste(filePath, 'MRI_', subjType, '_', exp, '_accuracy.df', sep="")
