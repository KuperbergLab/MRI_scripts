...
if __name__ == "__main__":
        ...
        for mod in modalities:
          ...
          with open('/cluster/kuperberg/SemPrMM/MRI/results/behavioral_accuracy/'+mod+'_'+listPrefix+'_'+study+'_accuracy-short_new.log','w') as d:
             d.write('sub' + '\t' + 'LPRun1'+ '\t' + 'LPRun2'+ '\t' + 'LPRun3' + '\t' + 'LPRun4' + '\t' + 'HPRun1'+ '\t' + 'HPRun2'+ '\t' + 'HPRun3' + '\t' + 'HPRun4' + '\n')
		    ...
		    ttar = 0.0
		         ...
		         for i, line in enumerate(all_split):
                             if i != loglen-1:
                                ...
                                tmax = int(float(line[5])) + 2.2 ## 1200 ms after the prime onset, testing this field 
				##ttar = int(float(line[5])) + 1.0
                                code = str(line[9])
                                if code  == '11' or code == '12': ##animal prime
                                    anipri_trials+=1
                                elif code == '5' or code =='10': ## animal target
                                    anitar_trials+=1
                                ani_trials = anipri_trials + anitar_trials
                                if (code == '11' or code == '5' or code == '12' or code =='10'):
...
##                    rt_ani_avg = rt_ani_avg + float(rt_ani/(ani_trials))
                    acc_ani = (round(float(acc_ani/ani_trials),2)*100)
