...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% BaleenHP 2nd Level Statistics BatchFile
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% One Sample T Test UnRelated Filler VS Related Filelr 8mm outliers
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
matlabbatch{10}.spm.stats.factorial_design.dir = {'[new_dir]/UnRelFillvRelFill/'};
%%
matlabbatch{10}.spm.stats.factorial_design.des.t1.scans = {[UnRelFillvRelFill_images]};
%%
...
matlabbatch{12}.spm.stats.con.consess{1}.tcon.name = 'UnRelFillvRelFill';
