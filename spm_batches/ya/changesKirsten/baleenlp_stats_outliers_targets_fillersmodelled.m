% 8mm
mkdir('/autofs/cluster/kuperberg/SemPrMM/MRI/functionals/$subject/BaleenLP/$stat_folder/swra_target2/');
matlabbatch{1}.spm.stats.fmri_spec.dir ={'/autofs/cluster/kuperberg/SemPrMM/MRI/functionals/$subject/BaleenLP/$stat_folder/swra_target2/'};
...
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).onset = [$Run1RelatedPrimeOnsets $Run1UnrelatedPrimeOnsets $Run1UnrelatedFillerOnsets $Run1AnimalTargetOnsets $Run1AnimalPrimeOnsets];
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).duration = [$Run1RelatedPrimeDurations $Run1UnrelatedPrimeDurations $Run1UnrelatedFillerDurations $Run1AnimalTargetDurations $Run1AnimalPrimeDurations];
...
matlabbatch{1}.spm.stats.fmri_spec.sess(2).cond(3).onset = [$Run2RelatedPrimeOnsets $Run2UnrelatedPrimeOnsets $Run2UnrelatedFillerOnsets $Run2AnimalTargetOnsets $Run2AnimalPrimeOnsets];
matlabbatch{1}.spm.stats.fmri_spec.sess(2).cond(3).duration = [$Run2RelatedPrimeDurations $Run2UnrelatedPrimeDurations $Run2UnrelatedFillerDurations $Run2AnimalTargetDurations $Run2AnimalPrimeDurations];
...
matlabbatch{1}.spm.stats.fmri_spec.sess(3).cond(3).onset = [$Run3RelatedPrimeOnsets $Run3UnrelatedPrimeOnsets $Run3UnrelatedFillerOnsets $Run3AnimalTargetOnsets $Run3AnimalPrimeOnsets];
matlabbatch{1}.spm.stats.fmri_spec.sess(3).cond(3).duration = [$Run3RelatedPrimeDurations $Run3UnrelatedPrimeDurations $Run3UnrelatedFillerDurations $Run3AnimalTargetDurations $Run3AnimalPrimeDurations];
...
matlabbatch{1}.spm.stats.fmri_spec.sess(4).cond(3).onset = [$Run4RelatedPrimeOnsets $Run4UnrelatedPrimeOnsets $Run4UnrelatedFillerOnsets $Run4AnimalTargetOnsets $Run4AnimalPrimeOnsets];
matlabbatch{1}.spm.stats.fmri_spec.sess(4).cond(3).duration = [$Run4RelatedPrimeDurations $Run4UnrelatedPrimeDurations $Run4UnrelatedFillerDurations $Run4AnimalTargetDurations $Run4AnimalPrimeDurations];
