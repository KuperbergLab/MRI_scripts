% 8mm
mkdir('/autofs/cluster/kuperberg/SemPrMM/MRI/functionals/$subject/BaleenLP/$stat_folder/swra_fillersplit/');
matlabbatch{1}.spm.stats.fmri_spec.dir ={'/autofs/cluster/kuperberg/SemPrMM/MRI/functionals/$subject/BaleenLP/$stat_folder/swra_fillersplit/'};
...
%RelateFillers
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).name = 'UnrelatedFillers';
...
%Filler
matlabbatch{1}.spm.stats.fmri_spec.sess(2).cond(3).name = 'UnrelatedFillers';
...
%Filler
matlabbatch{1}.spm.stats.fmri_spec.sess(3).cond(3).name = 'UnrelatedFillers';
...
%Filler
matlabbatch{1}.spm.stats.fmri_spec.sess(4).cond(3).name = 'UnrelatedFillers';
