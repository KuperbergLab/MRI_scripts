%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% One sample T Test $contrast 8mm outliers
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%keys:
%'contrast'
%'con_dir'
...
matlabbatch{1}.spm.stats.factorial_design.masking.em = {'/autofs/cluster/kuperberg/Software/spm/templates/mask20_no_eyeballs.nii,1'};
