...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% MaskedMM 2nd Level Statistics Batch File
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%replace_dict must have the following keys:
%new_dir
%Dir_images
%UnRel_images
%UnRelVDir_images
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% One Sample T Test Directly-Related 8mm Outliers
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
matlabbatch{1}.spm.stats.factorial_design.dir = {'[new_dir]/Dir/'};
%%
matlabbatch{1}.spm.stats.factorial_design.des.t1.scans = {[Dir_images]};
%%
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Dir';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
matlabbatch{7}.spm.stats.factorial_design.dir = {'[new_dir]/UnRelVDir/'};
%%
matlabbatch{7}.spm.stats.factorial_design.des.t1.scans = {[UnRelVDir_images]};
%%
...
matlabbatch{9}.spm.stats.con.consess{1}.tcon.name = 'UnRelVDir';
