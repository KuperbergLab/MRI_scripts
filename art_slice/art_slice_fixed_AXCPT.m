...
study='AXCPT';
sessions={'022/3Dnii', '023/3Dnii', '024/3Dnii'};
for sub=1:length(subjects)
for crun=1:length(sessions)
session_dir{crun}=fullfile(path_subjects,subjects{sub},study,sessions{crun});
brain_dir=fullfile(path_subjects,subjects{sub},study,'masks');
% PARAMETERS
spm_defaults;
