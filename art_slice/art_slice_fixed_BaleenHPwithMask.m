function art_slice_fixed_BaleenHPwithMask
...
if (strcmp(spmv,'SPM5') | strcmp(spmv,'SPM8b') | strcmp(spmv,'SPM8') )
    spm_ver = 'spm5'; end
%subject information
subs={'sc13'};%{'ac1','ac2','ac3','ac6','ac7','ac8','ac11','ac12','ac13','ac14','ac16','ac19','ac20','ac22','ac23','ac24','ac28','ac31','ac33','sc1','sc3','sc4','sc5','sc6','sc7','sc8','sc10','sc11','sc13','sc14','sc15','sc16','sc18','sc19','sc20','sc21','sc22'};%,'ya3','ya5','ya6','ya7','ya8','ya9','ya12','ya15','ya16','ya17','ya19','ya20','ya21','ya22','ya23','ya24','ya25','ya26','ya27','ya29','ya30','ya31','ya32','ya33'};

%subs={'ac1','ac2','ac3','ac6','ac7','ac8','ac11','ac12','ac13','ac14','ac16','ac19','ac20','ac22','ac23','ac24','ac28','ac31','ac33','sc1','sc3','sc4','sc5','sc6','sc7','sc8','sc10','sc11','sc13','sc14','sc15','sc16','sc18','sc19','sc20','sc21','sc22'};%,'ya3','ya5','ya6','ya7','ya8','ya9','ya12','ya15','ya16','ya17','ya19','ya20','ya21','ya22','ya23','ya24','ya25','ya26','ya27','ya29','ya30','ya31','ya32','ya33'};
%subs={'ya8'};%{'ya1','ya2','ya4','ya5','ya6','ya7','ya9','ya12','ya15','ya16','ya17','ya18','ya19','ya20','ya21','ya22','ya23','ya24','ya25','ya26','ya27','ya29','ya30','ya31','ya32','ya33'};

selection=1:length(subs);

subjects=subs(selection);
path_subjects=[filesep,fullfile('cluster','kuperberg','SemPrMM','MRI','functionals')];
study='BaleenHP';
for sub=1:length(subjects)
path_withsub=fullfile(path_subjects,subjects{sub},study);
sessions_dir=dir(path_withsub)
sess=1
for i=1:length(sessions_dir)
 if  sessions_dir(i).name(1)=='0' 
     sessions{sess}=sessions_dir(i).name
     sess=sess+1
 end    
end 
for crun=1:length(sessions)
session_dir{crun}=fullfile(path_withsub,sessions{crun},'3Dnii');
brain_dir=fullfile(path_withsub,'masks');
% PARAMETERS
spm_defaults;
OUTSLICEdef =  4;  %  Threshold above sample means to filter slices
    
     fct_images{crun}= spm_select('List',session_dir{crun},'^BaleenHP.*\.nii');
     Pimages=strcat(session_dir{crun},filesep,strcat(fct_images{crun},',1'));
  ...
  % 'Automatic ( will generate ArtifactMask image ) | User specified mask ',...
   ...
   % if mask_flag == 2
    %    if strcmp(spm_ver,'spm5')
     %   maskimg = spm_select(1, '.*\.nii|.*\.img', 'Select mask image in functional space');
             maskimg = spm_select('List',brain_dir, '^brain.nii$');
             maskimg=strcat(brain_dir,filesep,strcat(maskimg,',1'));
    %    else  % spm2 version
