function art_slice_fixed_BaleenLPwithMask
...
if (strcmp(spmv,'SPM5') | strcmp(spmv,'SPM8b') | strcmp(spmv,'SPM8') )
    spm_ver = 'spm5'; end
%subject information
subs={'ac2','ac3'};%{'ac1','ac2','ac3','ac6','ac7','ac8','ac11','ac12','ac13','ac14','ac16','ac19','ac20','ac22','ac23','ac24','ac28','ac31','ac33','sc1','sc3','sc4','sc5','sc6','sc7','sc8','sc10','sc11','sc13','sc14','sc15','sc16','sc18','sc19','sc20','sc21','sc22'};%,'ya3','ya5','ya6','ya7','ya8','ya9','ya12','ya15','ya16','ya17','ya19','ya20','ya21','ya22','ya23','ya24','ya25','ya26','ya27','ya29','ya30','ya31','ya32','ya33'};
...
% PARAMETERS
spm_defaults;
OUTSLICEdef =  2;  %  Threshold above sample means to filter slices
    
     fct_images{crun}= spm_select('List',session_dir{crun},'^BaleenLP.*\.nii');
